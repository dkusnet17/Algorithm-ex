...
namespace TowerOfHanoi
{
    public class TWH
    {
        ...
        #region
        private IDictionary<string, int> towerMapping = new Dictionary<string, int>()
    {
        ...
        private int turns = 0;
        private Stack<string>[] towers;
        private IList<string> discs = new List<string>()
    {
        {"-----|-----"},
        {" ----|---- "},
        {"  ---|---  "},
